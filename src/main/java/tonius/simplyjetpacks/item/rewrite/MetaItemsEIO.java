...
public enum MetaItemsEIO {
	...
	THRUSTER_EIO_1("thruster.eio.1", null, EnumRarity.COMMON),
	THRUSTER_EIO_2("thruster.eio.2", null, EnumRarity.COMMON),
	THRUSTER_EIO_3("thruster.eio.3", null, EnumRarity.UNCOMMON),
	THRUSTER_EIO_4("thruster.eio.4", null, EnumRarity.RARE),
	THRUSTER_EIO_5("thruster.eio.5", null, EnumRarity.EPIC),
