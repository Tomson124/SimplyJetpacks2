...
public class ModelJetpack extends BipedModel {
	...
	public ModelJetpack() {
		...
		RendererModel leftCanister = new RendererModel(this, 0, 32).setTextureSize(64, 64);
		...
		RendererModel rightCanister = new RendererModel(this, 17, 32).setTextureSize(64, 64);
		...
		RendererModel leftTip1 = new RendererModel(this, 0, 45).setTextureSize(64, 64);
		leftTip1.addBox(1F, 1F, 3.1F, 3, 1, 3);
		leftTip1.setRotationPoint(0F, 0F, 0F);
		leftTip1.mirror = true;
		this.setRotation(leftTip1, 0F, 0F, 0F);

		RendererModel leftTip2 = new RendererModel(this, 0, 49).setTextureSize(64, 64);
		...
		RendererModel rightTip1 = new RendererModel(this, 17, 45).setTextureSize(64, 64);
		...
		RendererModel rightTip2 = new RendererModel(this, 17, 49).setTextureSize(64, 64);
		...
		RendererModel leftExhaust1 = new RendererModel(this, 35, 32).setTextureSize(64, 64);
		...
		RendererModel leftExhaust2 = new RendererModel(this, 35, 37).setTextureSize(64, 64);
		...
		RendererModel rightExhaust1 = new RendererModel(this, 48, 32).setTextureSize(64, 64);
		...
		RendererModel rightExhaust2 = new RendererModel(this, 35, 45).setTextureSize(64, 64);
