package tomson124.simplyjetpacks.init;
...
public final class SJDataComponentTypes {
    public static final DeferredRegister<DataComponentType<?>> REGISTRY = DeferredRegister.create(Registries.DATA_COMPONENT_TYPE, SimplyJetpacks.MODID);
